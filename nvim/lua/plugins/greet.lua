  ...
  ＼二つ		
		...
		dashboard.section.buttons = {
			...
			val = {
				...
				dashboard.button("f", "󰍉  find file", ":lua require('telescope.builtin').find_files({hidden=true}) <cr>"),
				dashboard.button("g", "󰀬  live grep", ":lua require('telescope.builtin').live_grep({hidden=true}) <cr>"),
				dashboard.button("r", "󰋚  recent file", ":lua require('telescope.builtin').oldfiles({hidden=true}) <cr>"),
